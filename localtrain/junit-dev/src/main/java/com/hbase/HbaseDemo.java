...
public class HbaseDemo {
    ...
    public static void main(String[] args) {
        try {
            ...
            //insertData("Student", user);
            //User user2 = new User("002", "xiaohong", "654321", "female", "18", "18757912212", "214214@csdn.com");
            //insertData("Student", user2);
            //List<User> list = getAllData("Student");
            ...
            //User user4 = getDataByRowKey("Student", "user-001");
    ...
    public static Connection initHbase() throws MasterNotRunningException,IOException {
        ...
        //configuration.set("hbase.master", "104.250.129.202:16000");
        //集群配置↓
    ...
    //查询所有表
    public static void listTableAll() {
        ...
        //String[] strings = new String[tableNames.length];
    ...
    public static void getNoDealData(String tableName) {
        try {
            ...
            for (Result result : resutScanner) {
                System.out.println("setStartRow:  " + result);
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
