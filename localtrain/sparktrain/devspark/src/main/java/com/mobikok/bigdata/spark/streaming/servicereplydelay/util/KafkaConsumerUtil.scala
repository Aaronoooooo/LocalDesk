...
object KafkaConsumerUtil {
  ...
  val broker_list = PropertiesUtil.getValue("kafka.broker.list")
  // kafka消费者配置
...
//    "auto.offset.reset" -> "earliest",
  ...
  def main(args: Array[String]): Unit = {
    ...
    val groupId:String = "gid"
    val value: InputDStream[ConsumerRecord[String, String]] = KafkaConsumerUtil.getKafkaStream(topics, ssc,groupId)
    value.map(record=>{
