...
public class XqTest {
    ...
    public void esTest() throws IOException {
        RestClient client= EsClient.getInstance("flydiysz.cn",32667);
        String queryString = "{\"query\":{\"match\":{\"Id\":\"c19e5f5aefdf482dbf4001c7ffcb72bd\"}}}";
        System.out.println(EsClient.getSource(client,queryString,"lyx-sys_web_log","lyx"));

        //System.out.println(EsClient.getSource(queryString,"sys_user","user-type"));
