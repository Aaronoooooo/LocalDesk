package com.mobikok.bigdata.scrm.servicereplydelay.util
...
//    props.put("bootstrap.servers", "104.250.147.226:6667,104.250.150.18:6667,104.250.141.66:6667")
    props.put("bootstrap.servers", "8.129.26.121:9092")
    props.put("acks", "1")
    ...
    // 获得log日志
    val srcPath = "src/main/resources/scrm_dwi_hive/chatrecords.txt"
